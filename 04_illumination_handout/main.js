...
function createSceneGraph(gl, resources) {
...

  {
    ...
    let redLight = new LightNode();
    redLight.uniform = 'u_light2';
    redLight.diffuse = [1, 0, 0, 1];
    redLight.specular = [1, 0, 0, 1];
    redLight.position = [2, 0.2, 0];
    redLight.append(createLightSphere());
